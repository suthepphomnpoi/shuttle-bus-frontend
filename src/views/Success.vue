            ...
            <div class="col-md-6">
                <div class="card p-3">
                    ...
                    <div class="arrow-group">
                        <button class="arrow-btn left-btn" @click="$router.push('/cancel')">
                            <span class="arrow left"></span>
                        </button>

                        <button class="btn btn-dark px-5 py-2" @click="$router.push('/confirm')">ถึงป้ายแล้ว</button>

                        <button class="arrow-btn right-btn" @click="$router.push('/cancel')">
